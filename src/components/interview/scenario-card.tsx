...
import type { Scenario, ScenarioType } from "@/lib/storage/types";
...
export function ScenarioCard({
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      if (data.usage) recordUsage(data.usage as AIUsage, "generate-questions");
      const questions = data.questions || [];
      const formatted = questions
        .map(
          (q: { difficulty: string; text: string }, i: number) =>
      ...
      <CardContent className="p-0">
        ...
        <div className="flex items-center gap-3 p-4">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            {/* Start Interview */}
            <Link href={`/jobs/${jobId}/interview/${scenario.id}`}>
